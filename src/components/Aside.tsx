...
export function Aside() {
  return (
    <aside className=" w-72 bg-[#0F3460] text-white border-r h-full p-4 flex flex-col items-center gap-4 overflow-auto">
      ...
      <div className="text-sm mt-2 space-y-2 flex flex-col items-start justify-center  w-full ">
